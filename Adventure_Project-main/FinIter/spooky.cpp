...
bool GhostManor::FirstRoom2(){
	...
	if(select == '1'){
		if(music == false){
		printw("You open the door with no issue, the knob turns easily, but as you look out the door, you are greeted\n"
		"with the sight of a roiling mass of shadow that hisses and grabs at your fingers. You slam the door shut.\n"
		"It is the only exit, but how do you make it safe?\n");
		getch();
		clear();
		}
		else if(music == true){
			release = true;
			loop = true;
			printw("You open the door with no issue, the knob turns easily, and as the music gently trills a\n"
			"morose tune behind you, you look out the door to find it leads into a neat hallway, with no furnishings\n"
			"that leads out doors. You leave the room behind you.\n");
		getch();
		clear();
		}
	}
	...
	printw("As you walk through the silent hall of the building, the music behind you grows ever more silent and the\n"
	"sounds of nature begin to take its place, as the dusty, stagnant air gives way to a cool evening breeze as you \n"
	"enter into a garden that seperates a disproportionately large house, and the surrounding courtyard around it.\n");
	getch();
return true;
}
	...
	do{
		if(location == 1){
			do
			{
				...
				"cradle, with a baby inside. The Portrait of the past.\n");
				if(pastClock == 2)
...
bool GhostManor::FinRoom2(){
	int pastClock = 1, presClock = 9, futrClock = 8;
	int amber = 2, crystal = 1, obsidian = 3;
	bool release = false;
	char choice = 0;
	bool rel2 = false;
	...
	do{
		...
		//
			...
			do
			{
				...
				"This is the Portrait of the \"Present\", though that seems outdated to you.\n");
				if(presClock == 9)
					printw("The clock's hour hand points to 9.\n\n");
				else if(presClock == 10)
					printw("The clock's hour hand points to 10.\n\n");
				else if(presClock == 11)
					printw("The clock's hour hand points to 11.\n\n");
				else if(presClock == 12)
					printw("The clock's hour hand points to 12.\n\n");
		...
		//
			...
			do
			{
				...
				"Portrait of the Future.\n");
				if(futrClock == 14)
					printw("The clock's hour hand points to 14.\n\n");
				else if(futrClock == 8)
					printw("The clock's hour hand points to 8.\n\n");
				else if(futrClock == 10)
					printw("The clock's hour hand points to 10.\n\n");
