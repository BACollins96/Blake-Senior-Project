...
bool GhostManor::FirstRoom(char choices[], int size){
	/*start_color();
	init_pair(1, COLOR_GREEN, COLOR_BLACK);
	attron(COLOR_PAIR(1));*/
	bool release = false;
...
bool GhostManor::SecRoom(char choices[], int size){
	int axe = 0;
	int fire = 0;
	int machete = 0;
	bool release = false;
...
bool GhostManor::FinRoom(char choices[], int size){
	int pastClock = 2, presClock = 11, futrClock = 6;
	int amber = 2, crystal = 1, obsidian = 3;
	bool release = false;
	char choice = 0;
